...
public class OI {
    ...
    //**Buttons**
 	...
 	public JoystickButton xBoxB = new JoystickButton(xbox,0),
	...
	//**Operation Variables**
	private final double HIGHSPEED = 1;
	private final double LOWSPEED = 0.5;
	private boolean throttleHigh = true;
    ...
    //xboxX.whenPressed();
    //xboxY.whenPressed();
    	btnL2.whenPressed(new DisableDrive());
    xboxStart.whenPressed(new ToggleDriveThrottle());
